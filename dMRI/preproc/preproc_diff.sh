...
paste -d"\0" sub-"${subid}"_ses-1_acq-rl_dwi.bvec sub-"${subid}"_ses-1_acq-lr_dwi.bvecs >> bvecs

echo merging "${subid}" bvals
paste -d"\0" sub-"${subid}"_ses-1_acq-rl_dwi.bvals sub-"${subid}"_ses-1_acq-lr_dwi.bvals >> bvals
